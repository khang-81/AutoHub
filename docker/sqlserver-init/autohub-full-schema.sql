...
CREATE TABLE [dbo].[cars] (
    ...
    [seats]            INT            NULL,
    [transmission]     NVARCHAR (16)  NULL,
    [fuel_type]        NVARCHAR (16)  NULL,
    [version]          BIGINT         NOT NULL CONSTRAINT [DF_cars_version] DEFAULT 0,
    [average_rating]   FLOAT          NULL,
    [review_count]     INT            NOT NULL CONSTRAINT [DF_cars_review_count] DEFAULT 0,
