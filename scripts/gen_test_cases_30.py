"""
Tạo bảng kiểm thử AutoHub - 30 test case, GỘP 1 BẢNG DUY NHẤT,
dùng ngôn ngữ đơn giản theo mẫu TC04.
"""
...
OUTPUT = r"C:\Do_an\Rent-A-Car\docs\Bang_Kiem_Thu_AutoHub.docx"
...
ROWS = [
    ...
    # ================== TC04: Đặt lịch xem xe (giữ đúng mẫu) ==================
...
p = doc.add_paragraph()
r = p.add_run("\nGhi chú: Bảng gồm 30 test case cho 17 nhóm chức năng chính. Kết quả \u201cPass\u201d nghĩa là đạt yêu cầu, \u201cFail\u201d là không đạt.")
